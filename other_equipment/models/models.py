...
class OtherEquipment(models.Model):
    ...
    # 单位为月
    freq_of_cal = fields.Text(string='檢驗週期', required=True)
    location_of_equipment = fields.Text(string='設備位置', size=500, required=True)
    equipment_owner = fields.Text(string='設備擁有者', size=500)
